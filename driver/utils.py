...
def save_figure(filepath, dpi=500, watermark_x=0.075, watermark_y=0.065,
                halign='center', left=0.15, bottom=0.1, fmt=None):
    """Add watermark and save the figure."""
    txt = "Made by Chicky"
    plt.figtext(watermark_x, watermark_y, txt, wrap=True,
                horizontalalignment=halign, fontsize=8, color="grey")
    plt.tight_layout()
